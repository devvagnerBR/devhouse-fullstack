    ...
    return (
        ...
        <div className=' w-100dvw h-100dvh flex bg-dev_primary-gray-900 max-xs:items-start max-xs:justify-center  p-4'>
            ...
            <section className=' flex flex-col w-full max-xs:justify-start h-full items-center justify-center gap-6'>
                ...
                <Button onClick={() => handleCreateRoom()} className='max-xs:w-[90%] xs:min-w-[400px] hover:bg-dev_primary-white-50/90  full h-14  transition-colors justify-center bg-dev_primary-white-50 flex p-2 items-center gap-2 rounded-sm text-dev_primary-green' >
                ...
                <form onSubmit={handleJoinRoom} className=' max-xs:w-[90%] xs:min-w-[400px]  flex items-center justify-center  flex-col  gap-4'>
                    <input
